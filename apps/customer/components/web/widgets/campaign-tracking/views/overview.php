            ...
            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                <div class="box-dashboard" style="padding-bottom: 0px">
                    <div class="progress-box" style="padding-bottom: 0px">
                        <div class="info">
                            <span class="name"><?php echo Yii::t('campaign_reports', 'Recipients');?></span><span class="number"><?php echo CHtml::link($campaign->stats->getDeliverySuccessCount(true), $recipientsUrl);?></span>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="box-dashboard">
                    <ul class="custom-list">
                        <?php if ($campaign->isRegular) { ?>
                            ...
                            <li><span class="cl-span"><?php echo $campaign->getAttributeLabel('started_at');?></span><span class="cl-span"><?php echo $campaign->startedAt; ?></span></li>
            ...
            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                <div class="box-dashboard">
                    <ul class="custom-list">
                        ...
                        <?php if ($campaign->option->getRegularOpenUnopenDisplayText()) { ?>
                            <li><span class="cl-span"><?php echo Yii::t('campaigns', 'Filtered sent to');?></span><span class="cl-span"><?php echo $campaign->option->getRegularOpenUnopenDisplayText();?></span></li>
                        <?php } ?>
                        ...
                        <?php if ($campaign->isRegular && !empty($campaign->stats->completitionRate)) { ?>
                            <li>
                                <span class="cl-span">
                                    <?php echo Yii::t('campaigns', 'Estimated completition rate');?></span><span class="cl-span"><?php echo Yii::t('campaigns', '{percentage}% sent so far, that is {processed} out of {count}', array(
                        ...
                        <?php if ($campaign->isAutoresponder) { ?>
                            ...
                            <?php if (!empty($campaign->option->autoresponder_open_campaign_id)) { ?>
                                <li><span class="cl-span"><?php echo Yii::t('campaigns', 'Current opens count for target campaign');?></span><span class="cl-span"><?php echo !empty($campaign->option->autoresponder_open_campaign_id) ? (int)$campaign->option->autoresponderOpenCampaign->getUniqueOpensCount(true) : null;?></span></li>
                            <?php } ?>
