    ...
    <div class="box box-primary borderless">
        <div class="box-header">
            ...
            <div class="pull-right">
                ...
                <?php echo CHtml::link(Yii::t('campaign_reports', 'All opens'), array($this->campaignReportsController . '/open', 'campaign_uid' => $campaign->campaign_uid), array('class' => 'btn btn-primary btn-flat', 'title' => Yii::t('campaign_reports', 'View all opens')));?>
                <?php if (!empty($canExportStats)) { ?>
                <?php echo CHtml::link(IconHelper::make('glyphicon-export') . Yii::t('campaign_reports', 'Export reports'), array($this->campaignReportsExportController . '/open_unique', 'campaign_uid' => $campaign->campaign_uid), array('target' => '_blank', 'class' => 'btn btn-primary btn-flat', 'title' => Yii::t('campaign_reports', 'Export reports')));?>
                <?php } ?>
