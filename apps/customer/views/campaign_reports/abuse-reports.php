    ...
    <div class="box box-primary borderless">
        <div class="box-header">
            ...
            <div class="pull-right">
            	...
            	<?php echo CHtml::link(IconHelper::make('refresh') . Yii::t('app', 'Refresh'), array($this->campaignReportsController . '/abuse_reports', 'campaign_uid' => $campaign->campaign_uid), array('class' => 'btn btn-primary btn-flat', 'title' => Yii::t('app', 'Refresh')));?>
    		</div>
