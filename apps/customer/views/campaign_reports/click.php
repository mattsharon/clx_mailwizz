    ...
    <div class="box box-primary borderless">
        <div class="box-header">
            ...
            <div class="pull-right">
                ...
                <?php echo CHtml::link(Yii::t('campaign_reports', 'All clicks'), array($this->campaignReportsController . '/click', 'campaign_uid' => $campaign->campaign_uid), array('class' => 'btn '.(empty($show) ? 'btn-default' : 'btn-primary').' btn-flat'));?>
                <?php echo CHtml::link(Yii::t('campaign_reports', 'Top clicks'), array($this->campaignReportsController . '/click', 'campaign_uid' => $campaign->campaign_uid, 'show' => 'top'), array('class' => 'btn '.($show == 'top' ? 'btn-default' : 'btn-primary').' btn-flat'));?>
                <?php echo CHtml::link(Yii::t('campaign_reports', 'Latest clicks'), array($this->campaignReportsController . '/click', 'campaign_uid' => $campaign->campaign_uid, 'show' => 'latest'), array('class' => 'btn '.($show == 'latest' ? 'btn-default' : 'btn-primary').' btn-flat'));?>
                <?php if (!empty($canExportStats)) {?>
                <?php echo CHtml::link(IconHelper::make('glyphicon-export') . Yii::t('campaign_reports', 'Export reports'), array($this->campaignReportsExportController . '/click', 'campaign_uid' => $campaign->campaign_uid), array('target' => '_blank', 'class' => 'btn btn-primary btn-flat', 'title' => Yii::t('campaign_reports', 'Export reports')));?>
                <?php } ?>
