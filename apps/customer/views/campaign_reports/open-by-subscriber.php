    ...
    <div class="box box-primary borderless">
        <div class="box-header">
            ...
            <div class="pull-right">
                ...
                <?php echo CHtml::link(Yii::t('campaign_reports', 'All opens'), array($this->campaignReportsExportController . '/open', 'campaign_uid' => $campaign->campaign_uid), array('class' => 'btn btn-primary btn-flat', 'title' => Yii::t('campaign_reports', 'View all campaign opens')));?>
                <?php echo CHtml::link(Yii::t('campaign_reports', 'Unique opens'), array($this->campaignReportsController . '/open_unique', 'campaign_uid' => $campaign->campaign_uid), array('class' => 'btn btn-primary btn-flat', 'title' => Yii::t('campaign_reports', 'View only unique opens')));?>
