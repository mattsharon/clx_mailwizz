        ...
        <div class="box-header">
            ...
            <div class="pull-right">
                ...
                <?php if (!empty($canExportStats)) {
                    echo CHtml::link(IconHelper::make('glyphicon-export') . Yii::t('campaign_reports', 'Export reports'), array($this->campaignReportsExportController . '/click_url', 'campaign_uid' => $campaign->campaign_uid, 'url_id' => $url->url_id), array('target' => '_blank', 'class' => 'btn btn-primary btn-flat', 'title' => Yii::t('campaign_reports', 'Export reports')));
                } ?>
