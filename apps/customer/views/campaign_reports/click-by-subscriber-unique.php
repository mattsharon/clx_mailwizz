    ...
    <div class="box box-primary borderless">
        <div class="box-header">
            ...
            <div class="pull-right">
                ...
                <?php echo CHtml::link(Yii::t('campaign_reports', 'All clicks'), array($this->campaignReportsController . '/click', 'campaign_uid' => $campaign->campaign_uid), array('class' => 'btn btn-primary btn-flat', 'title' => Yii::t('campaign_reports', 'Back to all clicks report')));?>
                <?php echo CHtml::link(Yii::t('campaign_reports', 'All subscriber clicks'), array($this->campaignReportsController . '/click_by_subscriber', 'campaign_uid' => $campaign->campaign_uid, 'subscriber_uid' => $subscriber->subscriber_uid), array('class' => 'btn btn-primary btn-flat', 'title' => Yii::t('campaign_reports', 'Back to all subscriber clicks')));?>
                <?php if (!empty($canExportStats)) {
                    echo CHtml::link(IconHelper::make('glyphicon-export') . Yii::t('campaign_reports', 'Export reports'), array($this->campaignReportsExportController . '/click_by_subscriber_unique', 'campaign_uid' => $campaign->campaign_uid, 'subscriber_uid' => $subscriber->subscriber_uid), array('target' => '_blank', 'class' => 'btn btn-primary btn-flat', 'title' => Yii::t('campaign_reports', 'Export reports')));
                } ?>
