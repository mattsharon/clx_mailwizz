    ...
    <div class="box box-primary borderless">
        <div class="box-header">
            ...
            <div class="pull-right">
                <?php echo CHtml::link(IconHelper::make('fa-users') . Yii::t('list_subscribers', 'Back to subscribers list'), array('list_subscribers/index', 'list_uid' => $list->list_uid), array('class' => 'btn btn-primary btn-flat', 'title' => Yii::t('list_subscribers', 'Back to subscribers list')));?>
