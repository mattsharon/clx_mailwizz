...
if ($viewCollection->renderContent) { ?>
    ...
    <div class="pull-right">
        <a href="javascript:;" class="btn btn-primary btn-flat toggle-campaigns-filters-form" title="<?php echo Yii::t('list_subscribers', 'Toggle filters form')?>"><?php echo IconHelper::make('filter');?></a>    
    </div>
    ...
    <div class="box box-primary borderless">
        <div class="box-header">
            <div class="pull-left">
                <h3 class="box-title"><span class="fa fa-users"><!-- --></span> <?php echo $pageHeading;?></h3>
            </div>
            <div class="pull-right">
                <?php echo CHtml::link(IconHelper::make('bulk') . Yii::t('app', 'Bulk action from source'), '#bulk-from-source-modal', array('data-toggle' => 'modal', 'class' => 'btn btn-primary btn-flat', 'title' => Yii::t('list_subscribers', 'Bulk action from source')));?>
                ...
                <?php echo CHtml::link(IconHelper::make('refresh') . Yii::t('app', 'Refresh'), array('list_subscribers/index', 'list_uid' => $list->list_uid), array('class' => 'btn btn-primary btn-flat', 'title' => Yii::t('app', 'Refresh')));?>
            </div>
            <div class="clearfix"><!-- --></div>
        </div>
        <div class="box-body">
