            ...
            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                <div class="box-dashboard" style="padding-bottom: 0px">
                    <div class="progress-box" style="padding-bottom: 0px">
                        <div class="info">
                            <span class="name"><?php echo Yii::t('campaign_reports', 'Recipients');?></span><span class="number"><?php echo CHtml::link($campaign->stats->getDeliverySuccessCount(true), array('campaign_reports/delivery', 'campaign_uid' => $campaign->campaign_uid));?></span>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="row">
            <div class="col-lg-6 col-md-6 col-sm-16 col-xs-12">
                <div class="box-dashboard">
                    <div class="progress-box">
                        <div class="info">
                            <span class="name"><?php echo Yii::t('campaign_reports', 'Clicks rate');?></span><span class="number"><?php echo $campaign->stats->getClicksRate(true);?>%</span>
                        </div>
                    ...
                    <ul class="custom-list">
                        ...
                        <li><span class="cl-span"><?php echo Yii::t('campaign_reports', 'Unique clicks rate');?></span></span><span class="cl-span"><?php echo $campaign->stats->getUniqueClicksRate(true);?>%</span></li>
            ...
            <div class="col-lg-6 col-md-6 col-sm-16 col-xs-12">
                <div class="box-dashboard">
                    <div class="progress-box">
                        <div class="info">
                            <span class="name"><?php echo Yii::t('campaign_reports', 'Opens rate');?></span><span class="number"><?php echo $campaign->stats->getOpensRate(true);?>%</span>
                        </div>
                    ...
                    <ul class="custom-list">
                        ...
                        <li><span class="cl-span"><?php echo Yii::t('campaign_reports', 'Unique opens rate');?></span></span><span class="cl-span"><?php echo $campaign->stats->getUniqueOpensRate(true);?>%</span></li>
