    ...
    <div class="box box-primary borderless">
        <div class="box-header">
            ...
            <div class="pull-right">
                <?php echo CHtml::link(IconHelper::make('cancel') . Yii::t('app', 'Cancel'), array('campaigns/template', 'campaign_uid' => $campaign->campaign_uid), array('class' => 'btn btn-primary btn-flat', 'title' => Yii::t('app', 'Cancel')));?>
                ...
                <?php foreach ($templates as $model) { ?>
                    <div class="box box-primary borderless panel-template-box">
                        ...
                        <div class="box-footer">
                            <a href="<?php echo Yii::app()->createUrl("campaigns/template", array("campaign_uid" => $campaign->campaign_uid, "do" => "select", "template_uid" => $model->template_uid));?>" class="btn btn-primary btn-flat"><?php echo IconHelper::make('glyphicon-screenshot') . '&nbsp;' . Yii::t('app', 'Choose');?></a>
                        </div>
                    </div>
                <?php } ?>
            </div>
