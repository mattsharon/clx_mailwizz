    ...
    <div class="box box-primary borderless">
        <div class="box-header">
            ...
            <div class="pull-right">
                <?php echo CHtml::link(IconHelper::make('glyphicon-folder-close') . Yii::t('campaigns', 'Manage groups'), array('campaign_groups/index'), array('class' => 'btn btn-primary btn-flat', 'title' => Yii::t('campaigns', 'Manage groups')));?>
                <?php echo CHtml::link(IconHelper::make('create') . Yii::t('app', 'Create new'), array('campaigns/create'), array('class' => 'btn btn-primary btn-flat', 'title' => Yii::t('app', 'Create new')));?>
                <?php echo CHtml::link(IconHelper::make('refresh') . Yii::t('app', 'Refresh'), array('campaigns/index'), array('class' => 'btn btn-primary btn-flat', 'title' => Yii::t('app', 'Refresh')));?>
            </div>
