                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="pull-right">
                            ...
                            <?php } ?>
                            <?php echo CHtml::link(Yii::t('campaigns', 'Google UTM tags'), '#google-utm-tags-modal', array('class' => 'btn btn-primary btn-flat', 'data-toggle' => 'modal', 'title' => Yii::t('campaigns', 'Google UTM tags')));?>
                            <?php if (!empty($campaign->option) && $campaign->option->plain_text_email == CampaignOption::TEXT_YES) { ?>
