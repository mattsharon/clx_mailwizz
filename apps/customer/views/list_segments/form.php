            ...
            <div class="box-header">
                ...
                <div class="pull-right">
                    <?php if (!$segment->isNewRecord) {
                        echo CHtml::link(IconHelper::make('create') . Yii::t('app', 'Create new'), array('list_segments/create', 'list_uid' => $list->list_uid), array('class' => 'btn btn-primary btn-flat', 'title' => Yii::t('app', 'Create new')));
                    } ?>
                    ...
                    <?php if (!$segment->isNewRecord) { ?>
                        <a href="<?php echo $this->createUrl('list_segments_export/index', array('list_uid' => $list->list_uid, 'segment_uid' => $segment->segment_uid));?>" class="btn btn-primary btn-flat" title="<?php echo Yii::t('list_export', 'Export segment');?>"><?php echo IconHelper::make('export') . Yii::t('list_export', 'Export segment');?></a>
                    <?php } ?>
                </div>
                <div class="clearfix"><!-- --></div>
            </div>
