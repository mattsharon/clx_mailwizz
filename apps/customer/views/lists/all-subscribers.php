...
if ($viewCollection->renderContent) { ?>
    ...
    <div class="pull-right">
        <a href="javascript:;" class="btn btn-primary btn-flat toggle-filters-form" title="<?php echo Yii::t('list_subscribers', 'Toggle filters form');?>"><?php echo IconHelper::make('filter');?></a>
    </div>
    ...
    <div class="box box-primary borderless">
        <div class="box-header">
            <div class="pull-left">
                <h3 class="box-title">
                    <?php echo IconHelper::make('fa-users') .  $pageHeading;?>
                </h3>
            </div>
            <div class="pull-right">
                <?php echo CHtml::link(IconHelper::make('back') . Yii::t('list_subscribers', 'Back to lists'), array('lists/index'), array('class' => 'btn btn-primary btn-flat', 'title' => Yii::t('list_subscribers', 'Back to lists')));?>
                <?php echo CHtml::link(IconHelper::make('refresh') . Yii::t('app', 'Refresh'), array('lists/all_subscribers'), array('class' => 'btn btn-primary btn-flat', 'title' => Yii::t('app', 'Refresh')));?>
            </div>
            <div class="clearfix"><!-- --></div>
        </div>
        <div class="box-body">
