...
if ($viewCollection->renderContent) { ?>
    <div class="box box-primary borderless">
        <div class="box-header">
            <div class="pull-left">
                <h3 class="box-title">
                    <?php echo IconHelper::make('glyphicon-send') . Yii::t('servers', 'Delivery servers');?>
                </h3>
            </div>
            <div class="pull-right">
                <?php if (AccessHelper::hasRouteAccess('delivery_servers/create')) { ?>
                <div class="btn-group" style="margin-right: 10px;">
                    <button type="button" class="btn btn-primary btn-flat dropdown-toggle" data-toggle="dropdown"> <?php echo Yii::t('servers', 'Create new server');?> <span class="caret"></span> </button>
                ...
                <?php echo HtmlHelper::accessLink(IconHelper::make('import') . Yii::t('app', 'Import'), '#csv-import-modal', array('data-toggle' => 'modal', 'class' => 'btn btn-primary btn-flat', 'title' => Yii::t('app', 'Import')));?>
                <?php } ?>
                <?php echo HtmlHelper::accessLink(IconHelper::make('export') . Yii::t('app', 'Export'), array('delivery_servers/export'), array('class' => 'btn btn-primary btn-flat', 'title' => Yii::t('app', 'Export')));?>
                <?php echo HtmlHelper::accessLink(IconHelper::make('refresh') . Yii::t('app', 'Refresh'), array('delivery_servers/index'), array('class' => 'btn btn-primary btn-flat', 'title' => Yii::t('app', 'Refresh')));?>
            </div>
            ...
            if ($collection->renderGrid) {
                ...
                $this->widget('zii.widgets.grid.CGridView', $hooks->applyFilters('grid_view_properties', array(
                    ...
                    'columns' => $hooks->applyFilters('grid_view_columns', array(
                        ...
                        array(
                            'name'  => 'name',
                            'value' => 'empty($data->name) ? null : HtmlHelper::accessLink($data->name, array("delivery_servers/update", "type" => $data->type, "id" => $data->server_id))',
                            'type'  => 'raw',
                        ), 
                        array(
                            'name'  => 'hostname',
                            'value' => 'HtmlHelper::accessLink($data->hostname, array("delivery_servers/update", "type" => $data->type, "id" => $data->server_id))',
                            'type'  => 'raw',
                        ),
                        array(
                            'name'  => 'username',
