    ...
    <div class="box box-primary borderless">
        <div class="box-header">
            ...
            <div class="pull-right">
                <?php 
                if (empty($archive)) {
                    echo HtmlHelper::accessLink(Yii::t('misc', 'View archived logs'), array('misc/campaigns_delivery_logs', 'archive' => 1), array('class' => 'btn btn-primary btn-flat', 'title' => Yii::t('misc', 'View archived logs')));
                } else {
                    echo HtmlHelper::accessLink(Yii::t('misc', 'View current logs'), array('misc/campaigns_delivery_logs'), array('class' => 'btn btn-primary btn-flat', 'title' => Yii::t('misc', 'View current logs')));
                }
                ?>
