    ...
    <div class="box box-primary borderless">
        <div class="box-header">
            ...
            <div class="pull-right">
                <?php echo HtmlHelper::accessLink(IconHelper::make('back') . Yii::t('app', 'Back'), array('customer_messages/index'), array('class' => 'btn btn-primary btn-flat', 'title' => Yii::t('app', 'Back')));?>
            </div>
