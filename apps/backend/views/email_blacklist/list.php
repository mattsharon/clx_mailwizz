...
if ($viewCollection->renderContent) { ?>
    ...
    <div class="pull-right">
        <a href="javascript:;" class="btn btn-primary btn-flat toggle-filters-form"><?php echo IconHelper::make('filter');?></a>
    </div>
    ...
    <div class="box box-primary borderless">
        <div class="box-header">
            <div class="pull-left">
                <h3 class="box-title">
                    <?php echo IconHelper::make('glyphicon-ban-circle') . Yii::t('email_blacklist', 'Blacklisted emails');?>
                </h3>
            </div>
            <div class="pull-right">
                <?php echo HtmlHelper::accessLink(IconHelper::make('delete') . Yii::t('app', 'Remove all'), array('email_blacklist/delete_all'), array('class' => 'btn btn-danger btn-flat delete-all', 'title' => Yii::t('app', 'Remove all'), 'data-message' => Yii::t('dashboard', 'Are you sure you want to remove all blacklisted emails?')));?>
                <?php echo HtmlHelper::accessLink(IconHelper::make('export') . Yii::t('app', 'Export'), array('email_blacklist/export'), array('class' => 'btn btn-primary btn-flat', 'target' => '_blank', 'title' => Yii::t('app', 'Export')));?>
                <?php 
                ...
                ?>
                <?php echo HtmlHelper::accessLink(IconHelper::make('create') . Yii::t('app', 'Create new'), array('email_blacklist/create'), array('class' => 'btn btn-primary btn-flat', 'title' => Yii::t('app', 'Create new')));?>
                <?php echo HtmlHelper::accessLink(IconHelper::make('refresh') . Yii::t('app', 'Refresh'), array('email_blacklist/index'), array('class' => 'btn btn-primary btn-flat', 'title' => Yii::t('app', 'Refresh')));?>
            </div>
            <div class="clearfix"><!-- --></div>
        </div>
        <div class="box-body">
