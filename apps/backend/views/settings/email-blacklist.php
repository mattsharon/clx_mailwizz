                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <div class="pull-right">
                            <a href="javascript:;" class="btn btn-primary btn-flat add-dnsbl"><?php echo IconHelper::make('create');?></a>
                            <?php echo CHtml::link(IconHelper::make('info'), '#page-info-dnsbl', array('class' => 'btn btn-primary btn-flat', 'title' => Yii::t('app', 'Info'), 'data-toggle' => 'modal'));?>
                        </div>
                            ...
                            <?php foreach ($blacklistModel->remote_dnsbls as $dnsbl) { ?>
                                <div class="dnsbl-item col-lg-6">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-3">
                                            <a href="javascript:;" class="btn btn-danger btn-flat remove-dnsbl"><?php echo IconHelper::make('delete');?></a>
                                        </div>
                                    </div>
                                </div>
                            <?php } ?>
