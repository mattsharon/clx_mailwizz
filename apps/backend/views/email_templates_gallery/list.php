        ...
        <div class="box-header">
            ...
            <div class="pull-right">
                ...
                if (AccessHelper::hasRouteAccess('email_templates_gallery/upload')) {
                    echo CHtml::link(IconHelper::make('upload') . Yii::t('email_templates', 'Upload template'), '#template-upload-modal', array('class' => 'btn btn-primary btn-flat', 'data-toggle' => 'modal', 'title' => Yii::t('email_templates', 'Upload template')));
                }
                ?>
                ...
                <?php echo HtmlHelper::accessLink(IconHelper::make('refresh') . Yii::t('app', 'Refresh'), array('email_templates_gallery/index'), array('class' => 'btn btn-primary btn-flat', 'title' => Yii::t('app', 'Refresh')));?>
            </div>
            <div class="clearfix"><!-- --></div>
        </div>
        <div class="box-body sortable-box">
            <?php foreach ($templates as $model) { ?>
            <div class="box box-primary borderless panel-template-box" style="height: 270px;" data-id="<?php echo $model->template_id;?>" data-url="<?php echo $this->createUrl('email_templates_gallery/update_sort_order');?>">
                ...
                <div class="box-footer">
                    <a href="<?php echo Yii::app()->createUrl("email_templates_gallery/delete", array("template_uid" => $model->template_uid));?>" class="btn btn-danger btn-flat btn-delete-template" data-confirm-text="<?php echo Yii::t('app', 'Are you sure you want to remove this item?')?>" title="<?php echo Yii::t('app', 'Delete');?>"><?php echo IconHelper::make('delete');?></a><a href="<?php echo Yii::app()->createUrl("email_templates_gallery/copy", array("template_uid" => $model->template_uid));?>" class="btn btn-primary btn-flat" title="<?php echo Yii::t('app', 'Copy');?>"><?php echo IconHelper::make('copy');?></a><a href="<?php echo Yii::app()->createUrl("email_templates_gallery/update", array("template_uid" => $model->template_uid));?>" class="btn btn-primary btn-flat" title="<?php echo Yii::t('app', 'Update');?>"><?php echo IconHelper::make('update');?></a>
                </div>
            </div>
            <?php } ?>
            <div class="clearfix"><!-- --></div>
