    ...
    <div class="box box-primary borderless">
        <div class="box-header">
            ...
            <div class="pull-right">
                <?php echo CHtml::link(IconHelper::make('fa-check-square') . Yii::t('app', 'Mark all as seen'), array('messages/mark_all_as_seen'), array('class' => 'btn btn-primary btn-flat', 'title' => Yii::t('app', 'Mark all as seen')));?>
                <?php echo CHtml::link(IconHelper::make('refresh') . Yii::t('app', 'Refresh'), array('messages/index'), array('class' => 'btn btn-primary btn-flat', 'title' => Yii::t('app', 'Refresh')));?>
            </div>
