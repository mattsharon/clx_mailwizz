            ...
            <div class="box-header">
        		...
        		<div class="pull-right">
                    ...
                    if (!$promoCode->isNewRecord) { 
                        echo HtmlHelper::accessLink(IconHelper::make('create') . Yii::t('app', 'Create new'), array('promo_codes/create'), array('class' => 'btn btn-primary btn-flat', 'title' => Yii::t('app', 'Create new'))) . ' ';
                    } 
                    echo HtmlHelper::accessLink(IconHelper::make('cancel') . Yii::t('app', 'Cancel'), array('promo_codes/index'), array('class' => 'btn btn-primary btn-flat', 'title' => Yii::t('app', 'Cancel')));
                    ?>
        		</div>
        	</div>
            <div class="box-body">
