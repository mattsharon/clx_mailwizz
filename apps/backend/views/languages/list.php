...
if ($viewCollection->renderContent) { ?>
    <div class="box box-primary borderless">
        <div class="box-header">
            <div class="pull-left">
                <h3 class="box-title">
                    <?php echo IconHelper::make('glyphicon-flag') . Yii::t('languages', 'Available languages');?>
                </h3>
            </div>
            <div class="pull-right">
                <?php 
                if (AccessHelper::hasRouteAccess('languages/upload')) {
                    echo CHtml::link(IconHelper::make('upload') . Yii::t('languages', 'Upload language pack'), '#language-upload-modal', array('class' => 'btn btn-primary btn-flat', 'data-toggle' => 'modal', 'title' => Yii::t('languages', 'Upload language pack')));
                }
                ?>
                <?php echo HtmlHelper::accessLink(IconHelper::make('create') . Yii::t('app', 'Create new'), array('languages/create'), array('class' => 'btn btn-primary btn-flat', 'title' => Yii::t('app', 'Create new')));?>
                <?php echo HtmlHelper::accessLink(IconHelper::make('refresh') . Yii::t('app', 'Refresh'), array('languages/index'), array('class' => 'btn btn-primary btn-flat', 'title' => Yii::t('app', 'Refresh')));?>
            </div>
