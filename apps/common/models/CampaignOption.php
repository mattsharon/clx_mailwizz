...
class CampaignOption extends ActiveRecord
{
	...
	{
		$rules = array(
            array('url_tracking, open_tracking, json_feed, xml_feed, plain_text_email', 'required'),
			array('url_tracking, open_tracking, json_feed, xml_feed, plain_text_email', 'length', 'max' => 3),
            array('url_tracking, open_tracking, json_feed, xml_feed, plain_text_email', 'in', 'range' => array_keys($this->getYesNoOptions())),
