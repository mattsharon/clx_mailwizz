	...
	BounceHandler::COMMON_RULES          => array(
		array(
			...
			'regex'		 => array(
                ...
                '/smtp;(\s*)?(550|554) 5\.7\.1 Service unavailable/i',
                ...
                '/smtp;(\s*)?553 5\.3\.0 (.*)?DNSBL/i',
                '/smtp;(\s*)?554 5\.5\.4 Mail contains unique UBE\/UCE characteristics/i',
                '/smtp;(\s*)?550 5\.7\.1 (.*)Relaying denied/i',
                ...
                '/smtp;(\s*)?550 5\.7\.1 Rejected - confirmed junk email/i',
                ...
                '/smtp;(\s*)?550 5\.5\.0 550 5\.7\.1 IP address refused/',
                '/smtp;(\s*)?550 (.*)?Poor Reputation Sender/i',
                '/smtp;(\s*)?554 (.*)?Please submit an unblock request/i',
                '/smtp;(\s*)?554 5\.7\.1 You are not allowed to connect/i',
                '/smtp;(\s*)?554 Mail from (.*)?refused, see RBL server/i',
                '/smtp;(\s*)?571 5\.7\.1 Message contains spam or virus or sender is blocked/i',
                '/smtp;(\s*)?554 (.*)?found on one or more DNSBLs, see/i',
                '/smtp;(\s*)?550 5\.7\.1 (.*)?RBL Restriction/i',
                ...
                '/smtp;(\s*)?554 5\.2\.0 (.*)?Spam content found/i',
                ...
                '/smtp;(\s*)?554 \(RTR:BL\)/i',
                '/smtp;(\s*)?550 5\.7\.1 Sorry, message looks like spam or phish/i',
                '/smtp;(\s*)?554 (.*)?RBL Reject/i',
                '/smtp;(\s*)?553 (.*)?DNSBL:ATTRBL/i',
                // '/smtp;(\s*)?(554|550) (.*)?blocked/i',
                ...
                '/smtp;(\s*)?554 5\.7\.1 Access denied/i',
                '/SMTP;(\s*)?550-5\.7\.0 Message considered as spam or virus, rejected/i',
                '/smtp;(\s*)?550 5\.7\.606 Access denied/i',
                '/smtp;(\s*)?550 SPAM:/i',
                // '/smtp;(\s*)?554 (.*)?Rejected/i',
                ...
                '/smtp;(\s*)?550 5\.7\.0 Message considered as spam or virus/i',
                '/smtp;(\s*)?554 5\.5\.4 Your IP (.*)?address has a bad reputation/i',
                ...
                '/smtp;(\s*)?550 (.*)?Poor Reputation Sender/i',
                '/smtp;(\s*)?550 5\.7\.1 Recipients have complained about included content/i',
                '/smtp;(\s*)?553 Message filtered/i',
                '/smtp;(\s*)?554 5\.1\.0 Sender denied/i',
